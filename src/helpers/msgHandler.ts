import Mensaje from './msgGeneralHandler';
...
class MsgHandler extends Mensaje {
    ...
    cantFind(model:String,crudType:crudType){
     ...
     */
    resultCrud(data:UpdateData, model:String, crud:crudType){
        ...
        else if(data.n) return this.cantFind(model,crudType.actualizar);
    }
...
export const msgHandler = new MsgHandler(null,null),enumCrud = crudType;